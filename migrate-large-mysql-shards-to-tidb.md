---
title: 大規模なデータセットのMySQLシャードをTiDBに移行およびマージする
summary: DumplingとTiDBLightningを使用してMySQLからTiDBにシャードの大規模なデータセットを移行およびマージする方法と、さまざまなMySQLシャードからTiDBに増分データ変更を複製するようにDMタスクを構成する方法を学びます。
---
